<?php $__env->startSection('title', 'تعيين كلمة مرور جديدة'); ?>

<?php $__env->startSection('content'); ?>
<main class="min-h-[calc(100vh-8rem)] bg-gray-50 px-4 py-10" dir="rtl">
    <section class="mx-auto w-full max-w-md">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <a href="<?php echo e(url('/')); ?>" class="mb-6 inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-indigo-600">
            ...
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', request()->email)); ?>" required readonly
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\almeaa lave\almeaa-laravel-new\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>