            ...
            <div class="flex justify-between items-center h-16 sm:h-20 gap-3">
                ...
                <nav class="hidden md:flex items-center gap-1">
                    ...
                    <a href="<?php echo e(route('faq')); ?>"
                       class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-amber-500 rounded-lg hover:bg-amber-50 transition-colors <?php echo e(request()->is('faq') ? 'text-amber-500 bg-amber-50' : ''); ?>">الأسئلة الشائعة</a>
                    <a href="<?php echo e(route('contact')); ?>"
                       class="px-3 py-2 text-sm font-bold text-gray-600 hover:text-amber-500 rounded-lg hover:bg-amber-50 transition-colors <?php echo e(request()->is('contact') ? 'text-amber-500 bg-amber-50' : ''); ?>">اتصل بنا</a>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <template x-for="course in searchResults.courses" :key="course.id">
                                        <a :href="`<?php echo e(url('/courses')); ?>/${course.id}`" class="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-xl transition-colors">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <template x-for="lesson in searchResults.lessons" :key="lesson.id">
                                        <a :href="`<?php echo e(url('/student/courses')); ?>/${lesson.course_id}/lessons/${lesson.id}`" class="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-xl transition-colors">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <template x-for="quiz in searchResults.quizzes" :key="quiz.id">
                                        <a :href="`<?php echo e(url('/student/quiz')); ?>/${quiz.id}`" class="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-xl transition-colors">
