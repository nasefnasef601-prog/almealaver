    ...
    <section class="mx-auto w-full max-w-md">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div class="mb-6 text-center">
                ...
                <h1 class="text-2xl font-black text-gray-900">إنشاء حساب جديد</h1>
                <p class="mt-1 text-sm text-gray-500">انضم إلينا وابدأ رحلة التعلم.</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition-shadow"
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input x-bind:type="show ? 'text' : 'password'" name="password" required minlength="8"
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input x-bind:type="show ? 'text' : 'password'" name="password_confirmation" required minlength="8"
                            class="w-full px-4 py-3 pl-10 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none text-left transition-shadow"
                            dir="ltr" placeholder="********">
                        <button type="button" @click="show = !show" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                            <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('login')); ?>" class="text-sm text-emerald-600 hover:underline font-bold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\almeaa lave\almeaa-laravel-new\resources\views\auth\register.blade.php ENDPATH**/ ?>