...
<div class="max-w-4xl mx-auto" x-data="quizApp(<?php echo e($totalQ); ?>, <?php echo e($timeLimit ?? 0); ?>)">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-4 mb-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <form action="<?php echo e(route('student.quiz.submit', $attempt->id)); ?>" method="POST" x-ref="submitForm">
                <?php echo csrf_field(); ?>
...
<script>
    function quizApp(totalQ, timeLimitMinutes) {
        return {
            current: 0,
            total: totalQ,
            questions: <?php echo json_encode($questionsArray->map(fn($q) => [
                'id' => $q->id, 'text' => $q->question_text_ar ?? $q->question_text, 'options' => $q->options ?? []) ?>,
            submittedAnswers: {},
            flagged: {},
            ...
            storageKey: 'quiz_attempt_<?php echo e($attempt->id); ?>',
...
<?php echo $__env->make('layouts.student', ['activeTab' => 'quizzes'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\almeaa lave\almeaa-laravel-new\resources\views\student\quiz-take.blade.php ENDPATH**/ ?>