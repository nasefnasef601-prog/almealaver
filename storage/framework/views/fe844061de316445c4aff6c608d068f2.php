        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
            ...
            <div class="lg:w-1/2 relative w-full">
                <div class="relative w-full max-w-lg mx-auto">
                    <img src="<?php echo e($hero['imageUrl'] ?? asset('images/homepage-hero-boy-platform.jpg')); ?>" alt="<?php echo e($hero['imageAlt'] ?? 'طالب يستخدم منصة المئة'); ?>" class="w-full h-auto rounded-3xl shadow-2xl border-4 border-white relative z-10 transform transition-transform hover:scale-[1.02]">
                    ...
                    <div class="p-6 text-right">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-1 text-amber-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($starCount = 0; $starCount < 5; $starCount++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<section class="py-20 bg-gray-50" x-intersect.threshold.20="$el.classList.add('animate-fade-in-up')" style="opacity: 0;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $featuredArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e(route('student.lesson.show', ['course' => $article->course_id, 'lesson' => $article->id])); ?>" class="group block h-full">
                <div class="h-full border border-gray-100 hover:shadow-xl transition-all duration-300 rounded-3xl group-hover:-translate-y-1 bg-white p-6 text-right flex flex-col">
                    <div class="flex items-center justify-between gap-3 mb-4">
                        ...
                        <span class="text-[11px] text-gray-400 font-bold">
                            <?php echo e($article->course?->title_ar ?? $article->course?->title ?? 'شرح عام'); ?>

                        </span>
                    </div>

                    <h3 class="font-bold text-gray-900 mb-3 leading-8 group-hover:text-indigo-600 transition-colors line-clamp-2">
                        <?php echo e($article->title_ar ?: $article->title); ?>

                    </h3>

                    <p class="text-sm text-gray-600 leading-7 line-clamp-4 flex-1">
                        <?php echo e(Str::limit(strip_tags($article->content_text_ar ?: $article->content_text), 150)); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredArticles->isEmpty()): ?>
